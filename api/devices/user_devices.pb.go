...
var file_api_devices_user_devices_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x67, 0x65, 0x32, 0x9a, 0x05, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x76,
...
var file_api_devices_user_devices_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
var file_api_devices_user_devices_proto_depIdxs = []int32{
	12, // 0: devices.UserDevice.opted_in_at:type_name -> google.protobuf.Timestamp
	...
	13, // 7: devices.UserDeviceService.GetAllUserDeviceValuation:input_type -> google.protobuf.Empty
	0,  // 8: devices.UserDeviceService.GetUserDeviceByAutoPIUnitId:input_type -> devices.GetUserDeviceByAutoPIUnitIdRequest
	13, // 9: devices.UserDeviceService.GetClaimedVehiclesGrowth:input_type -> google.protobuf.Empty
	4,  // 10: devices.UserDeviceService.GetUserDevice:output_type -> devices.UserDevice
	4,  // 11: devices.UserDeviceService.GetUserDeviceByTokenId:output_type -> devices.UserDevice
	8,  // 12: devices.UserDeviceService.ListUserDevicesForUser:output_type -> devices.ListUserDevicesForUserResponse
	10, // 13: devices.UserDeviceService.ApplyHardwareTemplate:output_type -> devices.ApplyHardwareTemplateResponse
	3,  // 14: devices.UserDeviceService.GetAllUserDeviceValuation:output_type -> devices.ValuationResponse
	6,  // 15: devices.UserDeviceService.GetUserDeviceByAutoPIUnitId:output_type -> devices.UserDeviceAutoPIUnitResponse
	11, // 16: devices.UserDeviceService.GetClaimedVehiclesGrowth:output_type -> devices.ClaimedVehiclesGrowth
