...
type Cabin struct {
	...
	Door struct {
		...
		Row1 struct {
			// All doors, including windows and switches.
			Left Door `json:"left,omitempty"`
			// All doors, including windows and switches.
			Right Door `json:"right,omitempty"`
		} `json:"row1,omitempty"`
		// All doors, including windows and switches.
		Row2 struct {
			// All doors, including windows and switches.
	...
	Seat struct {
		...
		Row1 struct {
			// All seats.
			Pos1 SeatDetails `json:"pos1,omitempty"`
			// All seats.
			Pos2 SeatDetails `json:"pos2,omitempty"`
			// All seats.
			Pos3 SeatDetails `json:"pos3,omitempty"`
		} `json:"row1,omitempty"`
		// All seats.
		Row2 struct {
			// All seats.
...
type Chassis struct {
	...
	Axle struct {
		// Axle signals
		Row1 AxleSignals `json:"row1,omitempty"`
		// Axle signals
		Row2 AxleSignals `json:"row2,omitempty"`
	} `json:"axle,omitempty"`
